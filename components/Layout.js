...
function Layout({ title, smallHeader, children, bgImage }) {
    ...
    return (
        <>
            ...
            <Head>
                <title>
                    {title ? `${title} | Cabsfour SSS` : "Cabsfour SSS"}
                </title>
                <meta
                    name="description"
                            ...
                            {title === "Home" && (
                                <div className="center-div">
                                    ...
                                    <p className="text-sm lg:text-lg xl:px-96">
                                        We ensure that we provide our clients
                                        the best security and protection that we
                                        can give Our workers are highly trained
                                        and our equipment are guaranteed
                                        top-notch. All of these are maintained
                                        well to perform at their best. Because
                                        at Cabsfour Security Systems Services,
                    ...
                    <div className="flex flex-wrap justify-between px-10 lg:px-20 pt-8 bg-[#111111] text-white shadow-inner pb-5">
                        <div className="w-full lg:w-1/3">
                            ...
                            <p className="text-[#999999]">
                                Cabsfour Security Systems Services is a Filipino
                                owned company formed by dedicated entrepreneurs
                                more than two Decades work experience in
                                electronic security system integration. We are
                                engaged in integrating various Electronic
                                Security products such as Business Security
                                System, Biometrics Access Controls, FDAS, IPBX,
                                Electric Fence, Structured Cabling, Solar System
                                Public Address System, Electrical, Alarm and
                                CCTV.
                            </p>
                        ...
                        <div className="w-full lg:w-1/5 mt-5 lg:mt-0">
                            <span className="custom-text-title">
                                Quick Links
                            </span>
