                ...
                <div className="px-0 mx-0">
                    <TransitionScroll
                        ...
                        <div className="py-10">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 pt-12 px-5">
                                {data?.services &&
                                    data.services.map((service) => (
                                        <div
                                            ...
                                            key={service.id}
                                            style={{
                                                "--hover-image": `url(${service.hoverImage})`,
                                            }}>
                                            <Image
                                                src={service.image}
                                                alt="CCTV"
                    ...
                    <TransitionScroll
                        ...
                        <div className="py-10 custom-div-design text-center text-white flex flex-col justify-center items-center">
                            ...
                            <p className="lg:text-xl px-10 py-6">
                                We are a hands-on company that provides
                                solutions for our clients&#39;
                                <br /> problems and anticipates future problems
                                before they arise.
                            </p>
                    ...
                    <TransitionScroll
                        ...
                        <div className="py-10 contact-div text-center text-white flex flex-col justify-center items-center">
                            <p className="text-2xl py-6 font-semibold">
                                For your comments and suggestions inquiry,
